...
public class RetrieveJokes extends AsyncTask<Void, Void, String> {
    ...
    public static String LOG_TAG = lordsomen.android.com.workwithgradle.RetrieveJokes.class.getSimpleName();
    private final lordsomen.android.com.workwithgradle.RetrieveJokes.Listener mListener;
    ...
    public RetrieveJokes(lordsomen.android.com.workwithgradle.RetrieveJokes.Listener listener) {
        mListener = listener;
    }
